...
const buttonVariants = {
  default:
    'inline-flex items-center justify-center rounded-xl bg-primary text-black px-4 py-2 text-sm font-semibold shadow transition-colors hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-ring',
  outline:
