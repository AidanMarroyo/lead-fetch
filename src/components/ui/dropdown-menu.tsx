  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          'z-50 min-w-[10rem] rounded-xl border border-border bg-card p-1 shadow-xl outline-none',
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        'flex w-full cursor-pointer select-none items-center gap-2 rounded-lg px-3 py-2 text-sm transition-colors',
